...
{{taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tas,
  ...
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tas,
                               ...
                               pch = 17, pcex = 1.5,
                               main = NULL, col = "black")
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tasmin,
  ...
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tasmin,
                               ...
                               pch = 18, pcex = 2,
                               main = NULL, col = "black")
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tasmax,
  ...
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$tasmax,
                               ...
                               main = NULL)
  taylor_from_spatraster_zones(obs = CHELSA_Trace21_1950$pr,
