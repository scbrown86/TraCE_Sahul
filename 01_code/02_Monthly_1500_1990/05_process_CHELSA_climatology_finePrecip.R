...
brown <- list(
    rast("/media/dafcluster4/storage/TraCE_1500_1990CE/1500_1990/out/pr/TraCE_downscaled_1500_1990_concat.nc",
        lyrs = 5761:5880
    ),
...
brown_pr_corr
panel(tapp(brown_pr_corr, "month", mean),
    range = c(0, 400),
...
abline(v = quantile(
    as.vector(values(deltas_fine$dtr[[c(5, 8)]])),
