...
huss <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/RELHUM/trace.01-36.22000BP-1990CE.cam2.h0.RELHUM.0000101-2204012.Sahul.concat.1500_1989CE.nc",
             "RELHUM")
...
pr <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/PRECC/trace.01-36.22000BP-1990CE.cam2.h0.PRECC.0000101-2204012.Sahul.concat.1500_1989CE.nc",
           "PRECC") +
...
# create ta_high
ta_high <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/T/trace.01-36.22000BP-1990CE.cam2.h0.T.0000101-2204012.Sahul.concat.1500_1989CE.nc",
                "T")
## need TA @ [z=20]
...
# create ta_low
ta_low <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/T/trace.01-36.22000BP-1990CE.cam2.h0.T.0000101-2204012.Sahul.concat.1500_1989CE.nc",
               "T")
## need TA @ z=26
...
# create tas
tsmx <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/TSMX/trace.01-36.22000BP-1990CE.cam2.h0.TSMX.0000101-2204012.Sahul.concat.1500_1989CE.nc", "TSMX")
tsmn <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/TSMN/trace.01-36.22000BP-1990CE.cam2.h0.TSMN.0000101-2204012.Sahul.concat.1500_1989CE.nc", "TSMN")
...
dtr_med <- tapp(dtr[[which(time(dtr) >= as.Date("1980-01-16"))]], "month", max)
...
# create uwind
uwind <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/U/trace.01-36.22000BP-1990CE.cam2.h0.U.0000101-2204012.Sahul.concat.1500_1989CE.nc",
              "U")
...
# create vwind
vwind <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/V/trace.01-36.22000BP-1990CE.cam2.h0.V.0000101-2204012.Sahul.concat.1500_1989CE.nc",
              "V")
...
# create zg_high
zg_high <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/Z3/trace.01-36.22000BP-1990CE.cam2.h0.Z3.0000101-2204012.Sahul.concat.1500_1989CE.nc",
                "Z3")
## need zg @ [z=20]
...
# create zg_low
zg_low <- rast("/media/dafcluster4/storage/TraCE_Monthly_halfDeg/Z3/trace.01-36.22000BP-1990CE.cam2.h0.Z3.0000101-2204012.Sahul.concat.1500_1989CE.nc",
               "Z3")
## need zg @z=26
