...
export OUTPUT_DIR="/media/dafcluster4/storage/TraCE_22k_1500CE/out/"
...
# singularity exec $SINGULARITY_IMG python $SCRIPT -t 12930 -i $INPUT_DIR -o $OUTPUT_DIR -tmp $SCRATCH_DIR
# singularity exec $SINGULARITY_IMG python $SCRIPT -t 25860 -i $INPUT_DIR -o $OUTPUT_DIR -tmp $SCRATCH_DIR
